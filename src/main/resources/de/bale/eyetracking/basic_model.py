...
# def create_basic_model():
#     image_input_left = Input((36, 60, 3), name="Image_Input_Left")
#     coordinates_input = Input((8,), name="Coordnates_Input")
#     first_convolution = Conv2D(16, 3, 2, activation='relu')
#     second_convolution = Conv2D(32, 3, 2, activation='relu')
#     third_convolution = Conv2D(32, 3, 2, activation='relu')
#     image_layer = Conv2D(16, 3, 2, activation='relu')(image_input_left)
#     image_layer = AveragePooling2D()(image_layer)
#     image_layer = Conv2D(32, 2, 2, activation='relu')(image_layer)
#     image_layer = AveragePooling2D()(image_layer)
#     image_layer = Conv2D(64, 2, 2, activation='relu')(image_layer)
#     image_layer = Flatten()(image_layer)
#     image_model = Model(inputs=image_input_left, outputs=image_layer, name="Image_Model")
#
#     # coordinates_layer = Dense(64, activation='relu')(coordinates_input)
#     # coordinates_layer = Dense(32, activation='relu')(coordinates_layer)
#     # coordinates_layer = Dense(16, activation='relu')(coordinates_layer)
...
#
#
# def fit_basic_model(left_and_right_eyes, positions, epochs):
#     model = create_basic_model()
#     callback = EarlyStopping(monitor='loss', patience=20, min_delta=0, verbose=1, restore_best_weights=True)
#     try:
#         model.fit(left_and_right_eyes, positions, batch_size=32, epochs=epochs, callbacks=[callback], verbose=0)
#     except ValueError:
#         pass
#     return model
